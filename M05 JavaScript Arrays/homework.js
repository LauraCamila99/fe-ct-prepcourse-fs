...
function devolverUltimoElemento(array) {
   ...
   var ultimoNumero=array[posicion];
   return ultimoNumero;
}
...
function incrementarPorUno(array) {
   ...
   var nuevoArreglo= array.map(function (num){ return num + 1});
   return nuevoArreglo;
}
...
function mesesDelAño(array) {
   ...
   var febrero=array.includes("Febrero");
